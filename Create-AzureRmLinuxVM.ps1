...
{   # Probably want to change this to certificate auth
    ...
    $SubscriptionID = $mySubscriptions[0]  # grab the first???
...
$SubscriptionName = $mySubscription.Subscription.SubscriptionName
Set-AzureRmContext -SubscriptionID $subscriptionId
Write-Host "Logged into Azure $SubscriptionName $subscriptionId" -ForegroundColor Green
$AzureLogin


#  If you want to set the variables statically, just unremark this sectio..
...
$VNetName = "VNet-AzResearch"
$VNetAddressPrefix = "10.0.0.0/16"
$VNetSubnetAddressPrefix = "10.0.0.0/24"
$nsgName = "NSG_AzResearch"
